...
function getAll(client, message) {
    const embed = new MessageEmbed().setAuthor(`${message.author.username},⚒ilTuttoFare🛠\nEcco a te una lista di tutti i comandi: ` , message.author.displayAvatarURL()).setColor('00ff46').setThumbnail(client.user.displayAvatarURL());
    ...
    embed.setFooter(`sono disponibili ${client.commands.size} comandi!💪`, message.author.displayAvatarURL())
